...
from modulo_dft import dft , idft # Modulo funzioni (trasformata e antitrasformata [np.sin, np.cos]) 

# Leggi il file audio (diapason.wav)
data, samplerate = sf.read('/home/gabriele/Downloads/distorta.wav')
print('-------------------------------')
...
sf.write('/home/gabriele/Downloads/new_distorta.wav', data, samplerate)
new_data, new_samplerate = sf.read('/home/gabriele/Downloads/new_distorta.wav')
...
axs[0].set_title('Potenza spettrale (distorta), picchi principali (termine centrale)')
axs[0].set_xlabel('Frequenza [Hz]')
axs[0].set_ylabel(r'$|X_k|^2$')
axs[0].legend(['Potenza spettrale'], fontsize=10)
...
# Salvataggio audio
sf.write('/home/gabriele/Laboratorio3/garage_band/Suoni creati/new_distorta(filt0).wav', np.real(anti_fft), samplerate, subtype='FLOAT')
sf.write('/home/gabriele/Laboratorio3/garage_band/Suoni creati/new_distorta(filt1).wav', np.real(anti_fft1), samplerate, subtype='FLOAT')
sf.write('/home/gabriele/Laboratorio3/garage_band/Suoni creati/new_distorta(filt2).wav', np.real(anti_fft2), samplerate, subtype='FLOAT')
sf.write('/home/gabriele/Laboratorio3/garage_band/Suoni creati/new_distorta(filt3).wav', np.real(anti_fft3), samplerate, subtype='FLOAT')

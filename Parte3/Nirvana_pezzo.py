...
data, samplerate = sf.read('/home/gabriele/Downloads/secondo.wav')
print('-------------------------------')
...
sf.write('/home/gabriele/Downloads/new_secondo.wav', data, samplerate)
new_data, new_samplerate = sf.read('/home/gabriele/Downloads/new_secondo.wav')
...
axs[0].set_title(r'Segnale originale [$\it{Nirvana\ -\ Smells\ Like\ Teen\ Spirit}$]')
...
axs[0].set_title(r'Potenza spettrale originale [$\it{Nirvana\ -\ Smells\ Like\ Teen\ Spirit}$]')
...
axs[1].set_title(r'Sintesi [$\it{Nirvana\ -\ Smells\ Like\ Teen\ Spirit}$]')
...
axs[0].set_title(r'Potenza spettrale [$\it{Nirvana\ -\ Smells\ Like\ Teen\ Spirit}$], Strumento: basso ')
axs[0].set_xlabel('Frequenza [Hz]')
axs[0].set_ylabel(r'$|X_k|^2$')
...
axs[1].set_title(r'Sintesi segnale filtrato [$\it{Nirvana\ -\ Smells\ Like\ Teen\ Spirit}$]')
axs[1].set_xlabel('Tempo')
axs[1].set_ylabel('Ampiezza')
axs[1].legend()
plt.show()
...
axs[0].set_title(r'Potenza spettrale [$\it{Nirvana\ -\ Smells\ Like\ Teen\ Spirit}$], Strumento: chitarra')
axs[0].set_xlabel('Frequenza [Hz]')
axs[0].set_ylabel(r'$|X_k|^2$')
axs[0].legend(['Potenza spettrale'], fontsize=10)
...
# Salvataggio audio
sf.write('/home/gabriele/Laboratorio3/garage_band/Suoni creati/new_secondo(filt0).wav', np.real(anti_fft), samplerate, subtype='FLOAT')
sf.write('/home/gabriele/Laboratorio3/garage_band/Suoni creati/new_secondo(filt1).wav', np.real(anti_fft1), samplerate, subtype='FLOAT')
